...
from wc_util import wc_3d_plot, wc_2d_plot, uv_2d_plot
from build_dataset_combine import Check_dir_exist_and_build, Check_dir_exist_and_build_new_dir, Save_as_jpg
...
def wc_2D_3D_and_uv_visual(wc_paths, uv_paths, page_names, dst_dir):
    start_time = time.time()
    ...
    task_amount = wc_amount
    _wc_2D_3D_and_uv_visual_multiprocess(wc_paths, uv_paths, page_names, wc_2d_dst_dir, wc_3d_dst_dir, uv_2d_dst_dir, core_amount=core_amount, task_amount=task_amount)
...
def _wc_2D_3D_and_uv_visual_multiprocess(wc_paths, uv_paths, page_names, wc_2d_dst_dir, wc_3d_dst_dir, uv_2d_dst_dir, core_amount, task_amount):
    multi_processing_interface(core_amount=core_amount, task_amount=task_amount, task=_wc_2D_3D_and_uv_visual, task_args=[wc_paths, uv_paths, page_names, wc_2d_dst_dir, wc_3d_dst_dir, uv_2d_dst_dir], print_msg=True)

def _wc_2D_3D_and_uv_visual(start_index, amount, wc_paths, uv_paths, page_names, wc_2d_dst_dir, wc_3d_dst_dir, uv_2d_dst_dir):
...
if(__name__ == "__main__"):
    from step0_Doc3D_obj import  real_doc3D, Fake_Doc3D, fake_doc3D_path
    ...
    page_names = using_doc3D.page_names
    ...
    ### 分析2
    wc_2D_3D_and_uv_visual(wc_paths, uv_paths, page_names, dst_dir=r"H:")
